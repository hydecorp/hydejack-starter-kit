...
[src]: https://github.com/hydecorp/hydejack-starter-kit/archive/v9.1.2.zip
...
```yml
## file: `_config.yml`
remote_theme: hydecorp/hydejack@v9.1.2
```
...
author:
  social:
    ...
    download: https://github.com/hydecorp/hydejack/archive/v9.1.2.zip
~~~
